...
export default function MagazineEntries(props) {
    ...
    if (props.isFullScreenViewMode === true) {
        ...
        return (
            <div>
                {any(at, mn, vo, is, pr, ps, da) && <p>
                    {singleLineMultiFieldValueFormatter([at, mn, vo, is, pr, ps, da], [false, false, true, true, true], ['s', '', '', '', '', 's'], [', ', ', ', ', ', ', ', ', ', ' ', ['(', ')']])}
                </p>}
                {any(pub, pl) && <p>
