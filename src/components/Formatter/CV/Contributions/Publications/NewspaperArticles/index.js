...
export default function NewspaperArticles(props) {
    ...
    if (props.isFullScreenViewMode === true) {
        ...
        return (
            <div>
                {any(at,ne,edi,se,pr, pd) && <p>
                    {singleLineMultiFieldValueFormatter([at,ne,edi,se,pr, pd], [false,false,true,true,true], ['s'], [', ', ', ', ', ', ', ', ' ', ['(',')']])}
                </p>}
                {any(pl,pc) && <p>
