    ...
    return (
        <div className={tw`fixed z-10 inset-0 overflow-y-auto`}>
            <div className={tw`flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0`}>
                ...
                <span className={tw`hidden sm:inline-block sm:align-middle sm:h-screen`}
                ...
                <div
                    ...
                    <div className={tw`hidden sm:block absolute top-0 right-0 pt-4 pr-4`}>
                        <button type="button"
                            ...
                            <svg className={tw`h-6 w-6`} xmlns="http://www.w3.org/2000/svg" fill="none"
                                 viewBox="0 0 24 24"
...
export function ModalSaveAnywayConfirm(props) {
    const {state, changeState} = props;
    return (
        <div className={tw`fixed z-10 inset-0 overflow-y-auto`}>
            <div className={tw`flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0`}>
                ...
                <div
                    ...
                    <div className={tw`sm:flex sm:items-start`}>
                        <div
                            className={tw`mx-auto flex-shrink-0 flex items-center justify-center h-12 w-12 rounded-full bg-yellow-100 sm:mx-0 sm:h-10 sm:w-10`}>
                            <svg className={tw`h-6 w-6 text-yellow-600`} xmlns="http://www.w3.org/2000/svg" fill="none"
                                 viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                      d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"/>
                            </svg>
                        ...
                        <div className={tw`mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left`}>
                            ...
                            <div className={tw`mt-2`}>
                                <p className={tw`text-sm text-gray-500`}>
                                    One or more required fields are missing, but you can still save the form.
                                </p>
                            </div>
                        </div>
                    </div>
                    <div className={tw`mt-5 sm:mt-4 sm:flex sm:flex-row-reverse`}>
                        <button type="button"
                                className={tw`w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-yellow-400 text-base font-medium text-white hover:bg-yellow-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500 sm:ml-3 sm:w-auto sm:text-sm`}
                                onClick={() => {
                                    changeState({
                                        ...state,
